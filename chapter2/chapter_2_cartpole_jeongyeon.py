...
for epixode_no in range(max_epixodes):
    explore_rate = select_explore_rate(epixode_no)
    learning_rate = select_learning_rate(epixode_no)
    ...
    for time_step in range(max_time_steps):
        ...
        print("Episode number : %d" % epixode_no)
        ...
        if completed:
            print("Episode %d finished after %f time steps" % (epixode_no, time_step))
